...
const SearchNav = ({ isOpen, onClose }: SearchNavProps) => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full h-24 transform transition-all duration-300 ease-in-out ${
      isOpen ? 'translate-y-0' : '-translate-y-full'
    } z-50 backdrop-filter backdrop-blur-[10px] border-b border-[rgba(var(--theme-rgb),0.2)] flex items-center justify-center gap-4 px-6`}>
      <button 
