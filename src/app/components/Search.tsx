...
const SearchComponent = () => {
  ...
  return (
    <section className="flex flex-col gap-5 m-6 z-10 relative p-8 backdrop-blur-md rounded-2xl border border-[rgba(var(--theme-rgb),0.2)] transition-all duration-300 hover:shadow-lg text-center">
      ...
      <div className="flex justify-center items-center gap-4 p-4 bg-[rgba(var(--background-rgb),0.05)] backdrop-blur-md border-b border-[rgba(var(--theme-rgb),0.1)] transition-transform duration-300 w-full">
        ...
        <button aria-label='Continue' onClick={handleSearch} className="p-3 bg-gradient-to-br from-[var(--theme)] to-[rgba(var(--theme-rgb),0.8)] text-foreground text-base font-semibold rounded-md transition-all duration-300 hover:translate-y-[-2px] hover:shadow-[0_6px_20px_rgba(var(--theme-rgb),0.3)]">
          <ArrowRight size={24} />
        </button>
      </div>
    </section>
